...
const ProductCreateScreen = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto mt-10">
      ...
      <h1 className="text-2xl font-bold mb-6 dark:text-white">Create Product</h1>

      {loadingCreate && <p className="text-blue-500">Creating...</p>}
      ...
      <form onSubmit={submitHandler} className="space-y-4 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
        ...
        <div>
          ...
          {image && (
            <div className="mb-4">
              <img src={image} alt="Preview" className="h-32 w-auto object-cover rounded-md border" />
            </div>
          )}
          <input
            type="text"
